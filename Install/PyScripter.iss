...
OutputDir=Output
OutputBaseFilename=PyScripter-v2.4.3-Setup
Compression=lzma
...
Name: {group}\PyScripter for Python 3.2; Filename: {app}\PyScripter.exe; Parameters: --PYTHON33
