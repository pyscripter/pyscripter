...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvAppInst.pas 13104 2011-09-07 06:50:43Z obones $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jcl.svn.sourceforge.net/svnroot/jvcl/trunk/jvcl/run/JvAppInst.pas $';
    Revision: '$Revision: 13104 $';
    Date: '$Date: 2011-09-07 09:50:43 +0300 (Τετ, 07 Σεπ 2011) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
