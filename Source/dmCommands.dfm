  ...
  object icSVGImages: TSVGIconImageCollection
    SVGIconItems = <
      ...
      item
        IconName = 'Breakpoint'
        SVGText = 
          '<svg viewBox="0 0 32 32">'#13#10#9'<path d="M16,28.9C8.9,28.9,3.1,23.1,' +
          '3.1,16S8.9,3.1,16,3.1S28.9,8.9,28.9,16S23.1,28.9,16,28.9z M16,6.' +
          '1c-5.5,0-9.9,4.4-9.9,9.9'#13#10#9#9's4.4,9.9,9.9,9.9s9.9-4.4,9.9-9.9S21.' +
          '4,6.1,16,6.1z"/>'#13#10'</svg>'#13#10
      end
      item
        IconName = 'BreakpointsRemove'
        SVGText = 
          '<svg viewBox="0 0 32 32">'#13#10#9'<path d="M22.6,9.7h-0.2c-0.1-4.8-4-8' +
          '.6-8.8-8.6c-4.9,0-8.8,4-8.8,8.8c0,1.5,0.4,3,1.1,4.2l0,0c0.8,1.5,' +
          '2,2.7,3.5,3.5'#13#10#9#9'c0.3,0.2,0.6,0.3,0.9,0.4l2.4-2.4c-2.8-0.4-4.9-2' +
          '.8-4.9-5.8c0-3.2,2.6-5.8,5.8-5.8c3.2,0,5.8,2.6,5.8,5.8c0,0.1,0,0' +
          '.2,0,0.4'#13#10#9#9'c-1.8,0.7-3.4,2-4.4,3.7l2.2-1c0.2-0.1,0.4-0.1,0.6-0.' +
          '2h0.1l0,0c0.2,0,0.5,0.1,0.7,0.2c0.3,0.2,0.6,0.4,0.7,0.8'#13#10#9#9'c0.1,' +
          '0.2,0.1,0.4,0.1,0.6c0,0.3-0.1,0.5-0.2,0.7L18,17.6c1.9-1.1,3.4-2.' +
          '8,4.1-4.9c0.2,0,0.4,0,0.7,0c3.2,0,5.8,2.6,5.8,5.8'#13#10#9#9's-2.6,5.8-5' +
          '.8,5.8c-3,0-5.5-2.3-5.8-5.3l-2.5,2.5c1.2,3.4,4.5,5.8,8.3,5.8c4.9' +
          ',0,8.8-4,8.8-8.8C31.4,13.6,27.4,9.7,22.6,9.7z"/>'#13#10#9'<polygon poin' +
          'ts="18.2,28.7 11.6,22.2 13.9,19.9 15.1,18.6 15.7,18 16.3,17.5 16' +
          '.8,16.4 17.9,14.3 17.8,14.3 17.8,14.3 16.6,14.9 '#13#10#9#9'15.5,15.4 14' +
          '.5,15.9 11.8,18.6 10,20.5 2.1,12.6 0.4,14.2 0.4,14.2 0.4,14.2 4.' +
          '4,18.2 8.3,22.1 5,25.4 1.7,28.7 1.7,28.7 1.7,28.7 '#13#10#9#9'3.3,30.4 3' +
          '.4,30.4 7.8,26 10,23.8 13.3,27.1 16.6,30.4 18.6,30.8 19,30.9 19,' +
          '30.9 19,30.9 '#9'"/>'#13#10'</svg>'#13#10
      end
      item
        IconName = 'BreakpointsWin'
        SVGText = 
          '<svg viewBox="0 0 32 32">'#13#10'<g transform="translate(-538.724 -764' +
          '.86)">'#13#10#9'<g transform="translate(539.69 764.86)">'#13#10#9#9'<path d="M3' +
          '0.6,5.2v18.7c0,1.7-1.4,3.1-3.1,3.1H15.9c0.5-0.8,0.8-1.7,1-2.7c0-' +
          '0.1,0.1-0.3,0.1-0.4h10.5V5.2H2.6v8.4'#13#10#9#9#9'c-0.4,0.3-0.9,0.5-1.3,0' +
          '.8c-0.7,0.5-1.3,1.1-1.8,1.8v-11c0-1.7,1.4-3.1,3.1-3.1h24.9C29.2,' +
          '2.1,30.6,3.5,30.6,5.2z"/>'#13#10#9#9'<path d="M30.6,5.2v18.7c0,1.7-1.4,3' +
          '.1-3.1,3.1H15.9c0.5-0.8,0.8-1.7,1-2.7c0-0.1,0.1-0.3,0.1-0.4h10.5' +
          'V5.3H2.6v8.4'#13#10#9#9#9'c-0.4,0.3-0.9,0.5-1.3,0.8C0.6,15,0,15.6-0.5,16.' +
          '3v-11c0-1.7,1.4-3.1,3.1-3.1h24.9C29.2,2.1,30.6,3.5,30.6,5.2z"/>'#13 +
          #10#9'</g>'#13#10#9'<g transform="translate(-0.026 -4.476)">'#13#10#9#9'<path d="M5' +
          '47,783.8c-1.8,0-3.4,0.6-4.7,1.6c-1.9,1.4-3,3.6-3,6.1c0,1.5,0.5,3' +
          ',1.2,4.2c1.4,2.1,3.8,3.6,6.5,3.6'#13#10#9#9#9'c2.5,0,4.7-1.2,6.1-3c0.7-0.' +
          '9,1.2-2,1.5-3.1c0.1-0.5,0.2-1.1,0.2-1.6C554.7,787.3,551.3,783.8,' +
          '547,783.8z M552.2,792.7'#13#10#9#9#9'c-0.1,0.8-0.5,1.5-1,2.1c-1,1.3-2.5,2' +
          '-4.2,2c-1.8,0-3.5-0.9-4.5-2.5c-0.6-0.8-0.9-1.8-0.9-2.9c0-1.7,0.8' +
          '-3.2,2.1-4.2'#13#10#9#9#9'c0.9-0.7,2-1.1,3.2-1.1c2.9,0,5.3,2.4,5.3,5.3C55' +
          '2.3,791.9,552.3,792.3,552.2,792.7z"/>'#13#10#9'</g>'#13#10'</g>'#13#10'</svg>'#13#10
      end
      item
        IconName = 'Bug'
        SVGText = 
      ...
      item
        IconName = 'CallStack'
        SVGText = 
          '<svg viewBox="0 0 32 32">'#13#10#9'<path d="M28.6,3.4H3.4c-1.7,0-3.1,1.' +
          '4-3.1,3.1v18.9c0,1.7,1.4,3.1,3.1,3.1h25.2c1.7,0,3.1-1.4,3.1-3.1V' +
          '6.6'#13#10#9#9'C31.7,4.8,30.3,3.4,28.6,3.4z M10.8,18.3h10.9v1.2H10.8V18.' +
          '3z M5.1,15.3v-1.3H16v1.3H5.1z M16,22.6h10.4v1.3H16V22.6z M3.4,6.' +
          '4'#13#10#9#9'h25.2v13.3c-0.2-0.1-0.5-0.2-0.7-0.2h-3.2v-2.8c0-0.8-0.7-1.5' +
          '-1.5-1.5H19v-2.8c0-0.8-0.7-1.5-1.5-1.5H3.6c-0.1,0-0.1,0-0.2,0'#13#10#9 +
          #9'L3.4,6.4L3.4,6.4z M3.4,25.4v-7.2c0,0,0.1,0,0.2,0h4.2v2.8c0,0.8,' +
          '0.7,1.5,1.5,1.5h3.8v2.8L3.4,25.4L3.4,25.4z"/>'#13#10'</svg>'#13#10
      end
      item
        IconName = 'Check'
        SVGText = 
          '<svg viewBox="0 0 32 32">'#13#10#9'<path d="M10.2,23.1l-7.6-7.6L0.1,18l' +
          '10.1,10.1L31.9,6.4l-2.5-2.5L10.2,23.1z"/>'#13#10'</svg>'#13#10
      end
      item
        IconName = 'CmdOuputWin'
        SVGText = 
          '<svg viewBox="0 0 32 32">'#13#10#9'<path d="M28.3,3.7H3.7C2,3.7,0.7,5.1' +
          ',0.7,6.8v18.4c0,1.7,1.3,3.1,3.1,3.1h24.5c1.7,0,3.1-1.3,3.1-3.1V6' +
          '.8'#13#10#9#9'C31.3,5.1,30,3.7,28.3,3.7z M28.3,25.2H3.7V6.8h24.5V25.2z"/' +
          '>'#13#10#9'<g transform="translate(3.7 5.5)">'#13#10#9#9'<path d="M6,14.9c0.5,0' +
          ',1-0.1,1.3-0.5c0.3-0.3,0.5-0.7,0.6-1.2h2c0,0.6-0.2,1.2-0.6,1.7s-' +
          '0.8,0.9-1.4,1.2'#13#10#9#9#9'c-0.6,0.3-1.3,0.5-1.9,0.4c-1.2,0.1-2.5-0.4-3' +
          '.3-1.3c-0.8-1-1.2-2.3-1.2-3.7v-0.2C1.4,10,1.9,8.8,2.7,7.7c0.8-0.' +
          '9,2-1.4,3.3-1.3'#13#10#9#9#9'c1,0,2,0.3,2.9,1C9.5,8.2,10,9.1,10,10.1h-2c0' +
          '-0.5-0.2-1-0.6-1.3C6.9,8.4,6.5,8.3,6,8.3c-0.6,0-1.2,0.3-1.6,0.8'#13 +
          #10#9#9#9'c-0.4,0.7-0.6,1.5-0.6,2.3v0.3c-0.1,0.8,0.1,1.6,0.6,2.3C4.6,1' +
          '4.6,5.3,14.9,6,14.9z"/>'#13#10#9#9'<path d="M12.9,6.5c0.3,0,0.7,0.1,0.9,' +
          '0.3C14,7,14.1,7.3,14.1,7.6c0,0.3-0.1,0.6-0.3,0.8c-0.5,0.4-1.3,0.' +
          '4-1.8,0'#13#10#9#9#9'c-0.2-0.2-0.3-0.5-0.3-0.8c0-0.3,0.1-0.6,0.3-0.8C12.2' +
          ',6.6,12.5,6.5,12.9,6.5z M12.9,14.2c0.3,0,0.7,0.1,0.9,0.3'#13#10#9#9#9'c0.' +
          '2,0.2,0.3,0.5,0.3,0.8s-0.1,0.6-0.3,0.8c-0.5,0.4-1.3,0.4-1.8,0c-0' +
          '.2-0.2-0.3-0.5-0.3-0.8s0.1-0.6,0.3-0.8S12.5,14.2,12.9,14.2'#13#10#9#9#9'z' +
          '"/>'#13#10#9#9'<path d="M15.5,3.4h2.1L23,17.5h-2.1L15.5,3.4z"/>'#13#10#9'</g>'#13#10 +
          '</svg>'#13#10
      end
      item
      ...
      item
        ...
        SVGText = 
          '<svg viewBox="0 0 32 32">'#13#10#9'<path d="M28.6,2.3H11.5c0,0,0.1,0,0.' +
          '1,0.1l3,3h7.8l0.2-0.2c0.3-0.3,0.7-0.4,1.1-0.4s0.8,0.2,1.1,0.4L25' +
          ',5.4h3.6V9l1.5,1.5'#13#10#9#9'c0.6,0.6,0.6,1.5,0,2.1l-1.5,1.5v10.2h-0.8c' +
          '0,0.3-0.2,0.6-0.4,0.8l-2.3,2.3h3.5c1.7,0,3.1-1.4,3.1-3.1V5.4'#13#10#9#9 +
          'C31.7,3.8,30.4,2.3,28.6,2.3z"/>'#13#10#9'<path d="M3.4,14.1l-1.7-1.7c-0' +
          '.6-0.6-0.6-1.5,0-2.1l1.7-1.7V5.4h3.1l3-3l0.1-0.1H3.4c-1.7,0-3.1,' +
          '1.4-3.1,3.1v18.9'#13#10#9#9'c0,1.7,1.4,3.1,3.1,3.1h12.8L16,27.2c-0.3-0.3' +
          '-0.4-0.7-0.4-1.1c0-0.4,0.1-0.8,0.4-1.1l0.6-0.7l0.2-0.2H3.3v-10H3' +
          '.4z"/>'#13#10#9'<polygon points="12.6,5.4 10.6,3.5 8.7,5.4 3.4,10.6 2.8' +
          ',11.3 3.4,12 7.3,15.8 10.1,13 10.2,13 11.1,13 12.2,13 12.9,13 12' +
          '.9,21.7 '#13#10#9#9'12.9,23.1 14.3,23.1 18.1,23.1 18.3,22.9 19.5,21.7 14' +
          '.3,21.7 14.3,13 14.9,13 15.9,13 17,13 16.1,14 21.4,19.3 28.6,12 ' +
          '29.1,11.6 '#13#10#9#9'28.6,11.2 23.8,6.3 18.4,11.6 17.4,11.6 16.3,11.6 1' +
          '3.6,11.6 12.5,11.6 11.5,11.6 15.1,8 '#9'"/>'#13#10#9'<polygon points="26.4' +
          ',24 22.8,20.5 20.3,23.1 18.9,24.5 17.2,26.2 18.4,27.4 20.7,29.7 ' +
          '23,27.4 26.1,24.3 '#9'"/>'#13#10'</svg>'#13#10
      end
      item
        IconName = 'Collapse'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          ...
          '.5,675.5L274.5,675.5z"/>'#13#10#9'<path d="M276.9,693.8l0.7-1.7l-1.9,1.' +
          '2L276.9,693.8z"/>'#13#10#9'<path d="M283.5,684.9l-4.8-6.1l-2,1.6l4.8,6.' +
          '1L283.5,684.9z"/>'#13#10#9'<path d="M280.6,688.4l-1.4-0.9l-3.6-2.3l-4.1' +
          '-2.6l-5.6-3.6v18.8l9-5.7l5.6-3.6L280.6,688.4z M268.5,692.9v-9'#13#10#9 +
          #9'l2.2,1.4l2.1,1.4l2.8,1.8l-0.4,0.2L268.5,692.9z"/>'#13#10'</g>'#13#10'</svg>' +
          #13#10
      end
      item
        IconName = 'DebugLast'
        SVGText = 
          ...
          '2l-4-5.1l-1.7,1.3l4,5.1L283.7,682z"/>'#13#10#9'</g>'#13#10#9'<path d="M4.4,8.9' +
          'v18l0.7-0.4c0.1-2.8,2.4-5.1,5.2-5.1H13l3.1-1.9l1.6-1l1-0.7L4.4,8' +
          '.9z M6.9,22.3v-8.6l6.8,4.3L6.9,22.3z"/>'#13#10#9'<path d="M18.6,28.8c0.' +
          '1,0.1,0.1,2,0.1,2h-8.4c-2.2,0-4-1.7-4-4c0-0.3,0.1-0.7,0.2-1.1c0.' +
          '5-1.7,2-2.9,3.8-2.9h7v-3l4,4l-4,4v-3h-7'#13#10#9#9'c-1.1,0-2,0.9-2,2s0.9' +
          ',2,2,2H18.6L18.6,28.8z"/>'#13#10'</svg>'#13#10
      end
      item
        IconName = 'Dedent'
        SVGText = 
      ...
      item
        IconName = 'Delete'
        SVGText = 
          '<svg viewBox="0 0 32 32">'#13#10#9'<path d="M24.9,10.2L27,5.9L22.5,8l-6' +
          '.2,6.2L5.6,3.5L3.4,5.8l10.7,10.7l-9,9l2.2,2.2l9-9l9,9l3.3,0.7l-1' +
          '.2-3l-8.9-8.9L24.9,10.2z"/>'#13#10'</svg>'#13#10
      end
      item
        IconName = 'Down'
        SVGText = 
      ...
      item
        IconName = 'Execute'
        SVGText = 
          '<svg viewBox="0 0 32 32">'#13#10#9'<path d="M14.2,32h-1.8l1.8-12.5H7.9c' +
          '-1.5,0-0.6-1.3-0.6-1.4C9.6,14.1,13,8,17.7,0h1.8l-1.7,12.5h6.3c0.' +
          '7,0,1.1,0.4,0.7,1.2'#13#10#9#9'C17.7,25.9,14.2,32,14.2,32z"/>'#13#10'</svg>'#13#10
      end
      item
        IconName = 'Exit'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          ...
          '31,1.3,30.4,0.6,29.5,0.6'#13#10#9#9'z"/>'#13#10#9'<path d="M29.8,19l-4.4-2.8L21' +
          ',13.4l-0.7-0.5L18,11.4l-4.5-2.9v22.9l10.9-6.9l6.8-4.4l0.2-0.1L29' +
          '.8,19z M25,20.6l-8.2,5.1V14.8'#13#10#9#9'l1.3,0.8l1.4,0.9l1.6,1l1,0.7l3.' +
          '4,2.2L25,20.6z"/>'#13#10'    <path transform="translate(-20,-2) scale(' +
          '1.8)"'#13#10'       d="M 16.684887,6.046032 14.284884,4.7159102 q -0.1' +
          '80723,-0.101205 -0.242169,-0.1807231 -0.05783,-0.079518 -0.05783' +
          ',-0.2024099 0,-0.1554218 0.112048,-0.2674701 0.112048,-0.1120483' +
          ' 0.263856,-0.1120483 0.09398,0 0.289157,0.1048194 l 3.574702,1.9' +
          '879538 -3.574702,1.9879538 q -0.195181,0.1084339 -0.289157,0.108' +
          '4339 -0.151808,0 -0.263856,-0.1120483 -0.112048,-0.1120483 -0.11' +
          '2048,-0.2710846 0,-0.1228917 0.05783,-0.2024099 0.06145,-0.07951' +
          '8 0.242169,-0.1807231 L 16.684887,6.046032 Z"'#13#10'     />'#13#10'</svg>'#13#10
      end
      item
        IconName = 'ExternalRunLast'
        SVGText = 
          '<svg viewBox="0 0 32 32">'#13#10#9'<path id="Trazado_1777_6_" d="M27.3,' +
          '28.5h1.3c1.7,0,3.1-1.4,3.1-3.1v-1.2L27.3,28.5z M28.6,3.4H3.3c-1.' +
          '7,0-3.1,1.4-3.1,3.1'#13#10#9#9'v18.9c0,1.7,1.4,3.1,3.1,3.1h20.8l-1.6-1.6' +
          'l1.5-1.5H3.3V6.6h25.2v12.3l1,1l2.1,2.2V6.6C31.7,4.8,30.3,3.4,28.' +
          '6,3.4z"/>'#13#10#9'<path d="M14.5,22.3c0.1,0.1,0.1,1.5,0.1,1.5H8.2c-1.6' +
          ',0-3-1.3-3-3c0-0.3,0.1-0.6,0.1-0.8c0.4-1.3,1.5-2.2,2.9-2.2h5.3v-' +
          '2.3l3,3'#13#10#9#9'l-3,3v-2.3H8.2c-0.8,0-1.5,0.7-1.5,1.5s0.7,1.5,1.5,1.5' +
          'L14.5,22.3L14.5,22.3z"/>'#13#10#9'<polygon points="30.6,23 30.7,23.1 25' +
          '.8,28 24.7,26.9 26.1,25.4 27.7,23.8 20.6,23.8 20.6,22.3 27.7,22.' +
          '3 24.7,19.1 25.8,18.1 '#13#10#9#9'28,20.3 28.6,20.9 '#9#9#9'"/>'#13#10'    <path tr' +
          'ansform="translate(-20) scale(1.8)"'#13#10'       d="M 16.684887,6.046' +
          '032 14.284884,4.7159102 q -0.180723,-0.101205 -0.242169,-0.18072' +
          '31 -0.05783,-0.079518 -0.05783,-0.2024099 0,-0.1554218 0.112048,' +
          '-0.2674701 0.112048,-0.1120483 0.263856,-0.1120483 0.09398,0 0.2' +
          '89157,0.1048194 l 3.574702,1.9879538 -3.574702,1.9879538 q -0.19' +
          '5181,0.1084339 -0.289157,0.1084339 -0.151808,0 -0.263856,-0.1120' +
          '483 -0.112048,-0.1120483 -0.112048,-0.2710846 0,-0.1228917 0.057' +
          '83,-0.2024099 0.06145,-0.079518 0.242169,-0.1807231 L 16.684887,' +
          '6.046032 Z"'#13#10'     />'#13#10'</svg>'#13#10
      end
      item
        ...
        SVGText = 
          ...
          '29.5,0.6z"/>'#13#10#9'<path d="M29.8,19l-4.4-2.8L21,13.4l-0.7-0.5L18,11' +
          '.4l-4.5-2.9v22.9l10.9-6.9l6.8-4.4l0.2-0.1L29.8,19z M25,20.6l-8.2' +
          ',5.1V14.8'#13#10#9#9'l1.3,0.8l1.4,0.9l1.6,1l1,0.7l3.4,2.2L25,20.6z"/>'#13#10' ' +
          '   <path transform="translate(-20,-2) scale(1.8)"'#13#10'       d="M 1' +
          '6.684887,6.046032 14.284884,4.7159102 q -0.180723,-0.101205 -0.2' +
          '42169,-0.1807231 -0.05783,-0.079518 -0.05783,-0.2024099 0,-0.155' +
          '4218 0.112048,-0.2674701 0.112048,-0.1120483 0.263856,-0.1120483' +
          ' 0.09398,0 0.289157,0.1048194 l 3.574702,1.9879538 -3.574702,1.9' +
          '879538 q -0.195181,0.1084339 -0.289157,0.1084339 -0.151808,0 -0.' +
          '263856,-0.1120483 -0.112048,-0.1120483 -0.112048,-0.2710846 0,-0' +
          '.1228917 0.05783,-0.2024099 0.06145,-0.079518 0.242169,-0.180723' +
          '1 L 16.684887,6.046032 Z"/>'#13#10'</g>'#9'   '#13#10'<path transform="scale(1.' +
          '3, 1.3)" d="M15,24V22H17V24H15M11,24V22H13V24H11M7,24V22H9V24H7Z' +
          '" />'#13#10'</svg>'#13#10
      end
      item
        IconName = 'Favorite'
      ...
      item
        ...
        SVGText = 
          ...
          '24)">'#13#10#9'<g transform="translate(-132.813 431.607)">'#13#10#9#9#9'<ellipse' +
          ' cx="11.9" cy="9" rx="1.5" ry="1.5"/>'#13#10#9#9#9'<ellipse cx="11.9" cy=' +
          '"17.4" rx="1.5" ry="1.5"/>'#13#10#9#9#9'<path d="M23.2,12.3h-7.5c-0.5,0-1' +
          '-0.4-1-1V6.7c0-0.5,0.4-1,1-1h7.5c0.5,0,1,0.4,1,1v4.6C24.2,11.9,2' +
          '3.8,12.3,23.2,12.3z'#13#10#9#9#9#9' M16.6,10.4h5.6V7.7h-5.6V10.4z"/>'#13#10#9#9'<g' +
          ' transform="translate(0)">'#13#10#9#9#9#9'<path d="M4.9,11.9l0.7,0.7L9,9.1' +
          'L5.6,5.7L4.9,6.3l2.9,2.9L4.9,11.9z"/>'#13#10#9#9'</g>'#13#10#9#9'<g transform="t' +
          'ranslate(0 4.415)">'#13#10#9#9#9#9'<path d="M4.9,15.6l0.7,0.7L9,12.8L5.6,9' +
          '.4l-0.7,0.7l2.9,2.9L4.9,15.6z"/>'#13#10#9#9'</g>'#13#10#9#9'<path d="M23.2,20.4h' +
          '-7.5c-0.5,0-1-0.4-1-1v-4.5c0-0.5,0.4-1,1-1h7.5c0.5,0,1,0.4,1,1v4' +
          '.6C24.2,20,23.8,20.4,23.2,20.4z'#13#10#9#9#9#9'M16.6,18.6h5.6v-2.8h-5.6V18' +
          '.6z"/>'#13#10#9'</g>'#13#10#9'<g transform="translate(-138.54 420.324)">'#13#10#9#9'<p' +
      ...
      item
        ...
        SVGText = 
          '<svg viewBox="0 0 32 32">'#13#10#9'<path d="M15.3,22.1c1.4,0,2.6-0.5,3.' +
          '7-1.1l3.7,3.7l2.1-2.1l-3.7-3.7c0.6-1.1,1.1-2.3,1.1-3.7c0-3.8-3.1' +
          '-6.9-6.9-6.9'#13#10#9#9's-6.9,3.1-6.9,6.9C8.4,19,11.4,22.1,15.3,22.1z M1' +
          '5.3,11.4c2.1,0,3.8,1.7,3.8,3.8S17.3,19,15.3,19s-3.8-1.7-3.8-3.8'#13 +
          #10#9#9'S13.1,11.4,15.3,11.4z M28.3,3.7H3.8C2,3.7,0.6,5.1,0.6,6.8v18.' +
          '4c0,1.7,1.4,3.1,3.1,3.1h24.5c1.7,0,3.1-1.4,3.1-3.1V6.8'#13#10#9#9'C31.4,' +
          '5.1,30,3.7,28.3,3.7z M28.3,25.2H3.8V6.8h24.5V25.2z"/>'#13#10'</svg>'#13#10
      end
      item
        IconName = 'FolderAdd'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          ...
          'lipPath>'#13#10'    </defs>'#13#10'    <g clip-path="url(#clip)">'#13#10'        <' +
          'path d="M28.7 12.9V3.1c0-1.6-1.4-3.1-3.1-3.1H6.4C4.8 0 3.3 1.4 3' +
          '.3 3.1v9.7h-3V19h3v9.8c0 1.6 1.4 3.1 3.1 3.1h19.3c1.6 0 2.9-1.2 ' +
          '3.1-2.9v-9.9h3v-6.2zM6.2 3.1c0-.1.1-.2.2-.2h19.3c.1 0 .2.1.2.2v9' +
          '.7H6.2zM3.2 16c0-.2 0-.3.1-.5.2-.8 1-1.4 1.8-1.4.4 0 .8.1 1 .4.5' +
          '.4.8.9.8 1.5s-.3 1.1-.8 1.5a1.83 1.83 0 0 1-2.8-1.1c-.1-.1-.1-.2' +
          '-.1-.4zm22.6 12.9c0 .1-.1.3-.2.3H6.4c-.1 0-.2-.1-.2-.2v-9.8h19.7' +
          'zm2.9-12.4c-.2.8-1 1.3-1.8 1.3-.4 0-.8-.1-1-.3-.5-.4-.8-.9-.8-1.' +
          '5s.3-1.1.8-1.5c.3-.2.7-.4 1-.4.9 0 1.6.6 1.8 1.3 0 .2.1.3.1.5 0 ' +
          '.3-.1.4-.1.6z"/>'#13#10'        <path d="M9 23.3h13.9v2.9H9z"/>'#13#10'     ' +
          '   <path d="M9 5.9h13.9v2.9H9z" />'#13#10'    </g>'#13#10'    <g transform="' +
          'matrix(.41205 -.43746 .39483 .41917 9.85 23.27)">'#13#10'        <path' +
          ' d="M28 9.9h-4.2c-.7-1.2-1.6-2.2-2.7-2.9l2.4-2.4-2.1-2.1-3.3 3.3' +
          'a7.61 7.61 0 0 0-4.2 0l-3.3-3.3-2.1 2.2 2.4 2.4c-1.1.8-2 1.8-2.7' +
          ' 2.9H4v3h3.1c-.1.4-.1.9-.1 1.4v1.5H4v3h3v1.5c0 .5.1 1 .1 1.5H4v3' +
          'h4.2c1.6 2.7 4.5 4.5 7.8 4.5s6.2-1.8 7.8-4.5H28v-3h-3.1c.1-.5.1-' +
          '1 .1-1.5v-1.5h3v-3h-3v-1.5c0-.5-.1-1-.1-1.5H28zm-6 6v4.5c0 .3 0 ' +
          '.7-.1 1l-.1 1-.6 1a6 6 0 0 1-5.2 3c-2.1 0-4.1-1.2-5.2-3l-.6-1-.1' +
          '-1c-.1-.2-.1-.7-.1-1.1v-6c0-.3 0-.7.1-1l.1-1 .6-1c.5-.8 1.1-1.5 ' +
          '1.8-2l.9-.6 1.1-.3c.5-.1.9-.2 1.4-.2.5 0 .9.1 1.4.2l1 .2.9.6c.8.' +
          '5 1.4 1.2 1.8 2l.6 1 .2 1c.1.3.1.7.1 1v1.7zm-9 3h6v3h-6zm0-6h6v3' +
          'h-6z" id="path2-2"/>'#13#10'    </g>'#13#10'</svg>'
      end
      item
        IconName = 'GoToLine'
        SVGText = 
          '<svg viewBox="0 0 32 32">'#13#10#9'<path d="M28.7,12.9V3.1c0-1.6-1.4-3.' +
          '1-3.1-3.1H6.4c-1.6,0-3.1,1.4-3.1,3.1v9.7h-3v6.2h3v9.8c0,1.6,1.4,' +
          '3.1,3.1,3.1h19.3'#13#10#9#9'c1.6,0,2.9-1.2,3.1-2.9v-9.9h3v-6.2L28.7,12.9' +
          'L28.7,12.9z M6.2,3.1c0-0.1,0.1-0.2,0.2-0.2h19.3c0.1,0,0.2,0.1,0.' +
          '2,0.2v9.7H6.2'#13#10#9#9'L6.2,3.1L6.2,3.1z M3.2,16c0-0.2,0-0.3,0.1-0.5c0' +
          '.2-0.8,1-1.4,1.8-1.4c0.4,0,0.8,0.1,1,0.4c0.5,0.4,0.8,0.9,0.8,1.5' +
          #13#10#9#9's-0.3,1.1-0.8,1.5c-0.3,0.2-0.7,0.3-1,0.3c-0.9,0-1.6-0.6-1.8-' +
          '1.4C3.2,16.3,3.2,16.2,3.2,16z M25.8,28.9c0,0.1-0.1,0.3-0.2,0.3'#13#10 +
          #9#9'H6.4c-0.1,0-0.2-0.1-0.2-0.2v-9.8h19.7L25.8,28.9L25.8,28.9z M28' +
          '.7,16.5L28.7,16.5c-0.2,0.8-1,1.3-1.8,1.3c-0.4,0-0.8-0.1-1-0.3'#13#10#9 +
          #9'c-0.5-0.4-0.8-0.9-0.8-1.5s0.3-1.1,0.8-1.5c0.3-0.2,0.7-0.4,1-0.4' +
          'c0.9,0,1.6,0.6,1.8,1.3l0,0c0,0.2,0.1,0.3,0.1,0.5'#13#10#9#9'C28.8,16.2,2' +
          '8.7,16.3,28.7,16.5z"/>'#13#10#9'<rect x="9" y="23.3" width="13.9" heigh' +
          't="2.9"/>'#13#10#9'<rect x="9" y="5.9" width="13.9" height="2.9"/>'#13#10'</s' +
          'vg>'#13#10
      end
      item
        IconName = 'Help'
      ...
      item
        IconName = 'Highlight'
        SVGText = 
          '<svg viewBox="0 0 32 32">'#13#10#9'<rect x="2.3" y="26.9" width="24.9" ' +
          'height="5"/>'#13#10#9'<path d="M29.3,13.1L17.6,0.7C16.9,0,15.7,0,15,0.6' +
          'l-3.9,3.7c-0.4,0.4-0.6,0.7-0.6,1.2s0.1,1,0.5,1.4l1.7,1.9l-1,1'#13#10#9 +
          #9'c-0.5,0.5-0.7,1.2-0.5,1.9c-0.2,0.1-0.6,0.2-0.9,0.5l-7.1,6.7c-0.' +
          '4,0.4-0.6,0.9-0.6,1.4v1.4c0,0.5,0.2,1,0.5,1.2L4.3,24'#13#10#9#9'c0.4,0.4' +
          ',0.9,0.6,1.4,0.6h7.6c0.5,0,1.1-0.2,1.4-0.6l3.4-4c0.2-0.2,0.4-0.5' +
          ',0.4-0.7c0.1,0,0.2,0,0.4,0l0,0c0.5,0,1-0.1,1.2-0.5'#13#10#9#9'l1-1l1.4,1' +
          '.4c0.4,0.4,0.9,0.6,1.4,0.6c0.5,0,0.9-0.1,1.2-0.5l4.1-3.9c0.4-0.4' +
          ',0.4-0.6,0.4-1.1C29.9,13.9,29.7,13.4,29.3,13.1z'#13#10#9#9#9'M12.6,20.9H6' +
          '.8l5-4.7l2.6,2.7L12.6,20.9z M24.2,15.4l-9.1-9.6l1.2-1.1l9.1,9.6L' +
          '24.2,15.4z"/>'#13#10'</svg>'#13#10
      end
      item
        IconName = 'Indent'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          ...
          ',12,12S22.6,28,16,28z"/>'#13#10'</svg>'#13#10
      end
      item
        IconName = 'Keyboard'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          '<svg viewBox="0 0 32 32">'#13#10'<path d="M20.5,4v10.5H5.8L4,16.3V4H20' +
          '.5 M22,1H2.5C1.7,1,1,1.7,1,2.5v21l6-6h15c0.8,0,1.5-0.7,1.5-1.5V2' +
          '.5'#13#10#9'C23.5,1.6,22.9,1,22,1z M29.5,7h-3v13.5H7v3C7,24.3,7.7,25,8.' +
          '5,25H25l6,6V8.5C31,7.6,30.4,7,29.5,7z"/>'#13#10'</svg>'#13#10
      end
      item
        IconName = 'Minus'
        SVGText = 
      ...
      item
        IconName = 'Options'
        SVGText = 
          '<svg viewBox="0 0 32 32">'#13#10#9'<g>'#13#10#9#9'<path d="M21.1,12.9H11c-0.8,0' +
          '-1.4,0.6-1.4,1.4v10.1c0,0.8,0.6,1.4,1.4,1.4h10.1c0.8,0,1.4-0.6,1' +
          '.4-1.4v-10'#13#10#9#9#9'C22.6,13.6,21.9,12.9,21.1,12.9z M21.1,24.5H11V14.' +
          '4h10.1V24.5z M20.4,17.2l-1-1L14.6,21l-1.9-1.9l-1,1l2.9,2.9L20.4,' +
          '17.2z"/>'#13#10#9'</g>'#13#10#9'<g transform="translate(-272.1 -317.4)">'#13#10#9#9'<p' +
          'ath d="M290.9,318.8h-11.3c-1.6,0-2.9,1.3-2.8,2.9v23.4c0,1.6,1.2,' +
          '2.9,2.8,2.9h17c1.6,0,2.9-1.3,2.8-2.9'#13#10#9#9#9'v-17.6L290.9,318.8z M27' +
          '9.6,345.2v-23.4h9.9v7.3h7.1v16.1H279.6z"/>'#13#10#9'</g>'#13#10'</svg>'#13#10
      end
      item
        IconName = 'PageSetup'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          ...
          ',0.7,6.8v18.4c0,1.7,1.3,3.1,3.1,3.1h24.5c1.7,0,3.1-1.3,3.1-3.1V6' +
          '.8'#13#10#9#9'C31.3,5.1,30,3.7,28.3,3.7z M28.3,25.2H3.7V6.8h24.5V25.2z"/' +
          '>'#13#10'<g transform="scale(1.1) translate(2,3)">'#13#10'  <path d="M19,14.' +
          '87V9.13c0-0.72-0.38-1.38-1-1.73l-5-2.88c-0.31-0.18-0.65-0.27-1-0' +
          '.27s-0.69,0.09-1,0.27L6,7.39 C5.38,7.75,5,8.41,5,9.13v5.74c0,0.7' +
          '2,0.38,1.38,1,1.73l5,2.88c0.31,0.18,0.65,0.27,1,0.27s0.69-0.09,1' +
          '-0.27l5-2.88 C18.62,16.25,19,15.59,19,14.87z M11,17.17l-4-2.3v-4' +
          '.63l4,2.33V17.17z M12,10.84L8.04,8.53L12,6.25l3.96,2.28L12,10.84' +
          'z M17,14.87l-4,2.3v-4.6l4-2.33V14.87z"/>'#13#10'</g>'#13#10'</svg>'#13#10
      end
      item
        ...
        SVGText = 
          ...
          '<path d="M19,14.87V9.13c0-0.72-0.38-1.38-1-1.73l-5-2.88c-0.31-0.' +
          '18-0.65-0.27-1-0.27s-0.69,0.09-1,0.27L6,7.39 C5.38,7.75,5,8.41,5' +
          ',9.13v5.74c0,0.72,0.38,1.38,1,1.73l5,2.88c0.31,0.18,0.65,0.27,1,' +
          '0.27s0.69-0.09,1-0.27l5-2.88 C18.62,16.25,19,15.59,19,14.87z M11' +
          ',17.17l-4-2.3v-4.63l4,2.33V17.17z M12,10.84L8.04,8.53L12,6.25l3.' +
          '96,2.28L12,10.84z M17,14.87l-4,2.3v-4.6l4-2.33V14.87z"/>'#13#10#9'</g>'#13 +
          #10'</svg>'#13#10
      end
      item
      ...
      item
        ...
        SVGText = 
          ...
          'ransform="scale(1.25) translate(3.5,5.5)">'#13#10#9#9'<path d="M19,14.87' +
          'V9.13c0-0.72-0.38-1.38-1-1.73l-5-2.88c-0.31-0.18-0.65-0.27-1-0.2' +
          '7s-0.69,0.09-1,0.27L6,7.39 C5.38,7.75,5,8.41,5,9.13v5.74c0,0.72,' +
          '0.38,1.38,1,1.73l5,2.88c0.31,0.18,0.65,0.27,1,0.27s0.69-0.09,1-0' +
          '.27l5-2.88 C18.62,16.25,19,15.59,19,14.87z M11,17.17l-4-2.3v-4.6' +
          '3l4,2.33V17.17z M12,10.84L8.04,8.53L12,6.25l3.96,2.28L12,10.84z ' +
          'M17,14.87l-4,2.3v-4.6l4-2.33V14.87z"/>'#13#10#9'</g>'#13#10'</svg>'#13#10
      end
      item
        IconName = 'PyActivate'
        SVGText = 
      ...
      item
        IconName = 'PyDoc'
        SVGText = 
          '<svg viewBox="0 0 32 32">'#13#10#9'<path d="M11.5,12.4l0.9,0.4l0.6-0.5c' +
          '0.4-0.4,1.6-0.4,2.5,0l2.8,1c0.7,0.3,1.7,0.3,2.1,0l1.1-1c0.3-0.3-' +
          '0.1-0.7-0.8-1'#13#10#9#9'c-0.5-0.2-0.9-0.4-1.4-0.6c-0.5-0.2-0.9-0.3-1.4-' +
          '0.5c-1.3-0.4-1.7-0.3-2.1,0l-0.5,0.4l2.8,1l-0.2,0.1l-2.8-1l-1-0.4' +
          #13#10#9#9'c-0.8-0.3-1.8-0.4-2.3-0.1c-0.7,0.3-1,0.6-1.2,1C10.5,11.7,10.' +
          '7,12.1,11.5,12.4z M17.7,10.8c-0.1,0.1-0.5,0.1-0.7,0'#13#10#9#9'c-0.3-0.1' +
          '-0.5-0.3-0.3-0.4c0.1-0.1,0.5-0.1,0.7,0C17.7,10.5,17.8,10.7,17.7,' +
          '10.8z"/>'#13#10#9'<path d="M20.7,13.4c-0.4,0.4-1.6,0.4-2.5,0l-2.8-1c-0.' +
          '7-0.3-1.7-0.3-2.1,0l-1.1,1c-0.4,0.3,0.2,0.7,0.7,1c0.4,0.2,0.8,0.' +
          '5,1.3,0.6'#13#10#9#9'c0.5,0.2,0.9,0.3,1.5,0.5c0.8,0.2,1.7,0.3,2.1,0l0.5-' +
          '0.4l-2.9-1l0.2-0.1l2.9,1l1.4,0.6c0.8,0.3,1.4,0.2,2.1,0'#13#10#9#9'c0.7-0' +
          '.2,1-0.6,1.2-1.1c0.1-0.4,0-0.7-0.8-1l-1.1-0.4L20.7,13.4z M16.1,1' +
          '4.9c0.1-0.1,0.5-0.1,0.7,0c0.3,0.1,0.4,0.3,0.3,0.4'#13#10#9#9'c-0.1,0.1-0' +
          '.5,0.1-0.7,0C16.1,15.2,16,15,16.1,14.9z M21.6,13.4l0.5,0.2l0,0c0' +
          '.2,0.1,0.7,0.2,0.5,0.7c-0.2,0.5-0.5,0.7-1,0.9'#13#10#9#9'c-0.7,0.2-0.9,0' +
          '.2-1.3,0.1l-1.4-0.6l-2.9-1c-0.3-0.1-0.7-0.1-0.8,0l-0.2,0.1c-0.1,' +
          '0.1,0,0.3,0.4,0.5l0.7,0.3'#13#10#9#9'c-0.2,0-0.4,0.1-0.6,0.2c-0.1,0.1-0.' +
          '1,0.3,0,0.5c-0.4-0.1-0.7-0.2-0.9-0.3c-0.4-0.2-0.7-0.3-1.1-0.6c-0' +
          '.3-0.2-0.8-0.5-0.7-0.7'#13#10#9#9'l1.1-1c0.2-0.2,0.7-0.2,1.2,0l2.8,1c1.3' +
          ',0.5,2.8,0.5,3.4,0L21.6,13.4z"/>'#13#10#9'<path d="M30.4,14.7v-2.9l1.1-' +
          '1c0.4-0.3,0.5-0.7,0.4-1.2s-0.4-0.8-0.8-0.9L16.2,3.4c-0.5-0.2-0.9' +
          '-0.1-1.2,0.2L2.2,14.2'#13#10#9#9'C2.1,14.3,2,14.4,2,14.4c-0.9,0.7-2,2.1-' +
          '2,4.3C0,21.5,2,23,2.1,23c0.1,0.1,0.3,0.2,0.4,0.2c0.1,0.1,0.2,0.2' +
          ',0.4,0.2l15.1,5.2'#13#10#9#9'c0.1,0.1,0.3,0.1,0.5,0.1c0.3,0,0.7-0.1,0.9-' +
          '0.4l12.1-11.6c0.6-0.5,0.6-1.3,0-1.9C31.2,14.8,30.8,14.7,30.4,14.' +
          '7z M7.9,18.5'#13#10#9#9'L7.9,18.5l0.7,0.3l6.8,2.6V25l-9.4-3.5v-3.7L7.9,1' +
          '8.5z M3.1,20.3c-0.2-0.4-0.4-0.9-0.4-1.6c0-1.1,0.3-1.7,0.6-2v3.6l' +
          '0,0'#13#10#9#9'C3.2,20.4,3.1,20.4,3.1,20.3z M27.8,16.8l-10.1,9c0-0.1,0-0' +
          '.1,0-0.2v-3.3h0.1c0.2,0.1,0.3,0.1,0.5,0.1c0.2,0,0.3,0,0.5-0.1'#13#10#9 +
          #9'c0,0,0.1,0,0.1-0.1c0.1,0,0.2-0.1,0.3-0.2c0,0,0,0,0.1,0l8.6-7.7L' +
          '27.8,16.8z M16.1,6.1l12.2,4.3l-10.2,9.2L8.9,16l-3.4-1.3'#13#10#9#9'L16.1' +
          ',6.1z"/>'#13#10'</svg>'#13#10
      end
      item
        IconName = 'PySetup'
        SVGText = 
      ...
      item
        IconName = 'Refresh'
        SVGText = 
          '<svg viewBox="0 0 512 512" >'#13#10#9'<path d="M463.702,162.655L442.491' +
          ',14.164c-1.744-12.174-16.707-17.233-25.459-8.481l-30.894,30.894'#13 +
          #10#9#9'C346.411,12.612,301.309,0,254.932,0C115.464,0,3.491,109.16,0.' +
          '005,248.511c-0.19,7.617,5.347,14.15,12.876,15.234l59.941,8.569'#13#10 +
          #9#9'c8.936,1.304,17.249-5.712,17.125-15.058C88.704,165.286,162.986' +
          ',90,254.932,90c22.265,0,44.267,4.526,64.6,13.183l-29.78,29.78'#13#10#9 +
          #9'c-8.697,8.697-3.761,23.706,8.481,25.459l148.491,21.211C456.508,' +
          '181.108,465.105,172.599,463.702,162.655z"></path>'#13#10#9'<path d="M49' +
          '9.117,249.412l-59.897-8.555c-7.738-0.98-17.124,5.651-17.124,16.1' +
          '43c0,90.981-74.019,165-165,165'#13#10#9#9'c-22.148,0-44.048-4.482-64.306' +
          '-13.052l28.828-28.828c8.697-8.697,3.761-23.706-8.481-25.459L64.6' +
          '46,333.435'#13#10#9#9'c-9.753-1.393-18.39,6.971-16.978,16.978l21.21,148.' +
          '492c1.746,12.187,16.696,17.212,25.459,8.481l31.641-31.626'#13#10#9#9'C16' +
          '5.514,499.505,210.587,512,257.096,512c138.794,0,250.752-108.618,' +
          '254.897-247.28'#13#10#9#9'C512.213,257.088,506.676,250.496,499.117,249.4' +
          '12z"></path>'#13#10'</svg>'
      end
      item
        IconName = 'RegExp'
      ...
      item
        ...
        SVGText = 
          ...
          '2,7H13V9H4V15H13V17H2V7M20,15V9H17V15H20Z" />'#13#10'</svg>'#13#10
      end
      item
        IconName = 'Replace'
        SVGText = 
      ...
      item
        IconName = 'Run'
        SVGText = 
          '<svg viewBox="0 0 32 32">'#13#10'<path d="M28.5,16.1l-2.4-1.5L20,10.6l' +
          '-7-4.5L3.5,0V32l15.2-9.6l9.5-6.1L28.5,16.1z M8,23.9V8.7l3.8,2.4'#13 +
          #10#9'l3.6,2.4l4.7,3.1l-0.7,0.3L8,23.9z"/>'#13#10'</svg>'#13#10
      end
      item
        ...
        SVGText = 
          ...
          '1-4.1z"/>'#13#10'    <polygon points="23.3,23.3 21,21 19.2,22.8 21.2,2' +
          '4.7 16.1,24.7 16.1,27.2 21.2,27.2 19.2,29.1 21,30.9 25.9,26 25.4' +
          ',25.6"/>'#13#10'    <polygon points="26.4,8.8 21.6,8.8 21.6,3.9 19.7,3' +
          '.9 19.7,8.8 16.1,8.8 14.8,8.8 14.8,10.7 19.7,10.7 19.7,13.3 19.7' +
          ',15.6 21.6,15.5 21.6,11.6 21.6,10.7 26.4,10.6"/>'#13#10'    <path d="M' +
          '27.4 2.9A9.78 9.78 0 0 0 20.5 0c-2.5 0-4.9.9-6.8 2.9A9 9 0 0 0 1' +
          '1 8.4a9.64 9.64 0 0 0 .6 4.7l.9 1.8c.4.6.7 1 1.2 1.5.2.2.5.5.7.6' +
          '.2.2.4.3.6.5.8.6 1.7 1 2.6 1.3a8.8 8.8 0 0 0 5.6.1c.7-.2 1.6-.6 ' +
          '2.2-1 .6-.4 1.3-.8 1.8-1.5 4-3.7 4-9.8.2-13.5zm-1.3 12.2c-.2.2-.' +
          '4.4-.6.5-.6.6-1.4 1-2.2 1.3s-1.7.5-2.5.5h-.3c-1.2 0-2.3-.3-3.4-.' +
          '7-.7-.4-1.4-.8-2-1.5a7.8 7.8 0 0 1 0-10.9C16.6 2.8 18.6 2 20.5 2' +
          's4 .7 5.4 2.2c3.1 3.1 3.1 8 .2 10.9z"/>'#13#10'</svg>'#13#10#13#10
      end
      item
        ...
        SVGText = 
          ...
          '>'#13#10'    <polygon points="27.8,20.7 24.7,17.8 22.5,20 25.1,22.5 18' +
          '.5,22.5 18.5,25.7 25.1,25.7 22.5,28.2 24.7,30.4 31,24.1 30.5,23.' +
          '6"/>'#13#10'    <path d="M20.5 8l-2.3 2.2-1.7 1.6-3.7 3.6v.8l-.1 3.7h1' +
          '.5l2.5.1h.5l.2-.2 2.5-2.4.6-.6 3.1-3 2.2-2.1 1-.9 1-.9-.1-.2-.1-' +
          '.1-3.9-4.4zm4.2 1.3c-2.37 2.18-4.79 4.57-6.8 6.5-.52.43-1.06.96-' +
          '1.5 1.4h-1v-1l4-3.8 4-3.8.4-.4c.25.41.59.74.9 1.1z"/>'#13#10'    <path' +
          ' d="M31.5 4.6l-.1-.2-2.5-2.6c-.2-.2-.4-.3-.8-.3H28c-.1 0-.3.1-.4' +
          '.1-.1 0-.2.1-.2.2l-2.1 2.1a86.11 86.11 0 0 1 4.1 4.4l.4-.4 1.6-1' +
          '.7c.5-.4.5-1.1.1-1.6z"/>'#13#10'</svg>'#13#10#13#10
      end
      item
        IconName = 'RunLast'
        SVGText = 
          '<svg viewBox="0 0 32 32">'#13#10#9'<path d="M5.9,2.9v21.7l0.8-0.5c0.1-3' +
          '.4,2.9-6.1,6.3-6.1h3.3l3.7-2.3l1.9-1.2l1.2-0.8L5.9,2.9z M9,19V8.' +
          '6l8.2,5.2L9,19z"/>'#13#10#9'<path d="M23,26.8c0.1,0.1,0.1,2.4,0.1,2.4H1' +
          '3c-2.6,0-4.8-2.1-4.8-4.8c0-0.4,0.1-0.9,0.2-1.3c0.6-2,2.4-3.5,4.6' +
          '-3.5h8.4V16l4.8,4.8'#13#10#9#9'l-4.8,4.8v-3.6h-8.4c-1.3,0-2.4,1.1-2.4,2.' +
          '4s1.1,2.4,2.4,2.4L23,26.8L23,26.8z"/>'#13#10'</svg>'#13#10
      end
      item
        IconName = 'RunScript'
        SVGText = 
          ...
          '9M17 16V22L22 19L17 16Z" />'#13#10'</svg>'
      end
      item
        IconName = 'RunToCursor'
        SVGText = 
          '<svg viewBox="0 0 32 32">'#13#10#9'<path d="M20.6,15.9l-1.7-1.1L14.5,12' +
          'l-5-3.2L2.7,4.4v22.9l10.9-6.9l6.8-4.4L20.6,15.9z M5.8,21.5V10.7'#13 +
          #10#9#9'l2.7,1.7l2.6,1.7l3.4,2.2L14,16.4L5.8,21.5z"/>'#13#10#9'<polygon poin' +
          'ts="29.3,3.2 29.3,0.2 19.9,0.2 19.9,3.2 23.2,3.2 23.2,28.8 19.9,' +
          '28.8 19.9,31.8 29.3,31.8 29.3,28.8 26.2,28.8 '#13#10#9#9'26.2,3.2 '#9'"/>'#13#10 +
          '</svg>'#13#10
      end
      item
        IconName = 'Save'
      ...
      item
        ...
        SVGText = 
          '<svg viewBox="0 0 24 24">'#13#10'    <path transform="scale(1.5) trans' +
          'late(-4, -5)" d="M 14.232422 8.171875 L 13.171875 9.2324219 L 14' +
          '.640625 10.701172 L 13.171875 12.171875 L 14.232422 13.232422 L ' +
          '15.701172 11.763672 L 17.171875 13.232422 L 18.232422 12.171875 ' +
          'L 16.763672 10.701172 L 18.232422 9.2324219 L 17.171875 8.171875' +
          ' L 15.701172 9.640625 L 14.232422 8.171875 z M 7 10 L 7 12 L 12 ' +
          '12 L 12 10 L 7 10 z M 14.230469 13.46875 L 13.169922 14.529297 L' +
          ' 14.640625 16 L 13.169922 17.470703 L 14.230469 18.53125 L 15.70' +
          '1172 17.060547 L 17.171875 18.53125 L 18.232422 17.470703 L 16.7' +
          '61719 16 L 18.232422 14.529297 L 17.171875 13.46875 L 15.701172 ' +
          '14.939453 L 14.230469 13.46875 z M 7 15 L 7 17 L 12 17 L 12 15 L' +
          ' 7 15 z" clip-rule="evenodd" fill-rule="evenodd"/>'#13#10'</svg>'
      end
      item
      ...
      item
        IconName = 'TodoWin'
        SVGText = 
          '<svg viewBox="0 0 32 32">'#13#10#9'<path d="M13.6,22.6l-3.5-3.5L9,20.3l' +
          '4.7,4.7l10-10l-1.1-1.1L13.6,22.6z"/>'#13#10#9'<g transform="translate(-' +
          '180.6 -325.9)">'#13#10#9#9'<path d="M206.7,329.2h-6.1c-0.8-2.2-3.3-3.4-5' +
          '.5-2.5c-1.2,0.5-2.2,1.4-2.5,2.5h-6.1c-1.6,0-2.9,1.2-2.9,2.8'#13#10#9#9#9 +
          'v22.7c0,1.6,1.3,2.8,2.9,2.8h20.2c1.6,0,2.9-1.2,2.9-2.8V332C209.5' +
          ',330.4,208.2,329.2,206.7,329.2z M196.6,329.2'#13#10#9#9#9'c0.7,0,1.4,0.7,' +
          '1.4,1.4c0,0.7-0.7,1.4-1.4,1.4s-1.4-0.7-1.4-1.4C195.2,329.8,195.9' +
          ',329.2,196.6,329.2z M206.7,354.6h-20.2V332h2.9'#13#10#9#9#9'v4.2h14.4V332' +
          'h2.9V354.6z"/>'#13#10#9'</g>'#13#10'</svg>'#13#10
      end
      item
        IconName = 'Tools'
        SVGText = 
          '<svg viewBox="0 0 32 32">'#13#10'<path d="M20,19.8V13h2.7V7.7h8c0-4.4-' +
          '3.6-8-8-8H9.3V5L4-0.3H1.3V13H4l5.3-5.3V13h3.6l0.1,6.9L7.8,25v7.3' +
          'h17.6V25l-5.3-5.3L20,19.8'#13#10#9'L20,19.8z"/>'#13#10'</svg>'#13#10
      end
      item
        IconName = 'ToolsSetup'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          ...
          '7.5c-1,0-1.8,0.8-1.8,1.8v2.6l0,0.7H20v2.6h0.8l0,1.3v0.3c0,1,0.8,' +
          '1.8,1.8,1.8h7.5c1,0,1.8-0.8,1.8-1.8v-7.5'#13#10#9#9'C31.7,11.3,30.9,10.5' +
          ',30,10.5z M29,18.8h-5.6v-5.6H29V18.8z"/>'#13#10#9'<path d="M14.2,4.7h-2' +
          '.7c-0.2,0-0.4,0.2-0.4,0.4v2.7c0,0.2,0.2,0.4,0.4,0.4h2.7c0.2,0,0.' +
          '4-0.1,0.4-0.4V5.1'#13#10#9#9'C14.6,4.9,14.4,4.7,14.2,4.7z"/>'#13#10#9'<path d="' +
          'M24.9,17.8h2.7c0.2,0,0.3-0.2,0.4-0.4v-2.7c0-0.2-0.2-0.4-0.4-0.4h' +
          '-2.7c-0.2,0-0.4,0.2-0.4,0.4v2.7'#13#10#9#9'C24.5,17.6,24.7,17.8,24.9,17.' +
          '8z"/>'#13#10#9'<path d="M11.8,27.4h2.7c0.2,0,0.3-0.2,0.4-0.4v-2.7c0-0.2' +
          '-0.2-0.4-0.4-0.4h-2.7c-0.2,0-0.4,0.2-0.4,0.4V27'#13#10#9#9'C11.4,27.2,11' +
          '.6,27.4,11.8,27.4z"/>'#13#10#9'<rect x="0.1" y="11" width="2.6" height=' +
          '"2.6"/>'#13#10#9'<rect x="0.1" y="15.4" width="2.6" height="2.6"/>'#13#10#9'<r' +
          'ect x="0.1" y="6.6" width="2.6" height="2.6"/>'#13#10#9'<rect x="0.1" y' +
          '="24.2" width="2.6" height="2.6"/>'#13#10#9'<rect x="0.1" y="19.8" widt' +
          'h="2.6" height="2.6"/>'#13#10#9'<rect x="0.1" y="2.2" width="2.6" heigh' +
          't="2.6"/>'#13#10#9'<rect x="4.5" y="6.6" width="2.6" height="2.6"/>'#13#10#9'<' +
          'rect x="4.5" y="24.2" width="2.6" height="2.6"/>'#13#10#9'<rect x="11.2' +
          '" y="15.5" width="2.6" height="2.6"/>'#13#10#9'<rect x="15.6" y="15.5" ' +
          'width="2.6" height="2.6"/>'#13#10'</svg>'#13#10
      end
      item
        ...
        SVGText = 
          ...
          #10#9#9'L32,10.9z M26.1,14.8h-4v-4h4V14.8z"/>'#13#10#9'<polygon points="20,2' +
          '7.1 17.4,26.5 10.3,19.4 9.9,19.7 3.2,26.5 1.4,24.6 5.3,20.8 5.9,' +
          '20.1 8.5,17.6 0,9.1 0,8.9 0.2,8.9 '#13#10#9#9'1.8,7.3 3.4,8.9 10.3,15.7 ' +
          '11.9,14.1 15.2,10.9 15.2,10.9 15.9,10.6 16.1,10.4 18.7,9.2 17.9,' +
          '10.9 17,12.5 14.9,14.8 12.9,16.8 '#13#10#9#9'12.1,17.6 19.1,24.6 '#9#9#9'"/>'#13 +
          #10'</svg>'#13#10
      end
      item
        IconName = 'Undo'
      ...
      item
        ...
        SVGText = 
          ...
          'L 7 4 L 7 7 L 17 7 L 17 4 L 19 4 L 19 20 L 5 20 L 5 4 z M 17.091' +
          '797 8.8613281 L 14.970703 11.017578 L 13.908203 9.9570312 L 12.8' +
          '47656 11.017578 L 14.970703 13.138672 L 18.152344 9.921875 L 17.' +
          '091797 8.8613281 z M 7 10 L 7 12 L 12 12 L 12 10 L 7 10 z M 14.2' +
          '5 13.470703 L 13.189453 14.529297 L 14.658203 16 L 13.189453 17.' +
          '470703 L 14.25 18.529297 L 15.720703 17.060547 L 17.189453 18.52' +
          '9297 L 18.25 17.470703 L 16.78125 16 L 18.25 14.529297 L 17.1894' +
          '53 13.470703 L 15.720703 14.939453 L 14.25 13.470703 z M 7 15 L ' +
          '7 17 L 12 17 L 12 15 L 7 15 z"/>'#13#10'</svg>'#13#10
      end
      item
        IconName = 'Up'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          ...
          'path d="M11.5,26.8l-1.7-1.7l0,0l-3.1,3.1h6.2L11.5,26.8z M27.8,3.' +
          '5H3.1C1.4,3.5,0,4.8,0,6.6v14.5L3.1,18V6.5h11.3l1.9-1.9'#13#10#9#9#9'c1-1,' +
          '2.5-1,3.5,0l1.9,1.9h6.1V25h-4.3l-3.1,3.1h7.4c1.7,0,3.1-1.4,3.1-3' +
          '.1V6.5C30.9,4.8,29.5,3.5,27.8,3.5z"/>'#13#10#9#9'<path d="M23,22.3l-6.2,' +
          '6.2h-0.3l-3.4-3.4C13,25,13,25,13.1,24.8l6.2-6.2h0.3L23,22C23.1,2' +
          '2.2,23.1,22.3,23,22.3z"/>'#13#10#9#9'<path d="M21.7,10.1l-7.1,7.1c-0.1,0' +
          '.1-0.3,0.1-0.4,0l-3.5-3.5c-0.1-0.1-0.1-0.2,0-0.4l7.1-7.1h0.4l3.5' +
          ',3.5'#13#10#9#9#9'C21.8,9.8,21.8,10,21.7,10.1z"/>'#13#10#9#9'<path d="M11.5,20.2l' +
          '-7.1,7.1l-0.2,0.1l-3.6-3.6c-0.1-0.1-0.1-0.2,0-0.3l7.1-7.1H8l3.4,' +
          '3.4C11.6,19.8,11.6,20.1,11.5,20.2z"/>'#13#10#9'</g>'#13#10#9'<g transform="tra' +
          'nslate(501.44 775.606)">'#13#10#9#9'<path d="M11.5,14.5l-7.1,7.1H4.1l-3.' +
          '4-3.4c-0.1-0.1-0.1-0.2,0-0.3l7.1-7.1h0.3l3.4,3.4C11.6,14.3,11.6,' +
          '14.3,11.5,14.5z"/>'#13#10#9'</g>'#13#10#9'<g transform="translate(506.281 770.' +
          '728)">'#13#10#9#9'<path d="M16.8,9.3l-7.1,7.1c-0.1,0.1-0.3,0.1-0.4,0l-3.' +
          '5-3.5c-0.1-0.1-0.1-0.2,0-0.4l7.1-7.1h0.3l3.5,3.5'#13#10#9#9#9'C16.9,9.1,1' +
          '6.9,9.2,16.8,9.3z"/>'#13#10#9'</g>'#13#10#9'<g transform="translate(507.377 77' +
          '6.705)">'#13#10#9#9'<path d="M17,15.6l-6.2,6.2h-0.3l-3.4-3.4c-0.1-0.1-0.' +
          '1-0.2,0-0.3l6.2-6.2h0.3l3.4,3.4C17.1,15.5,17.1,15.6,17,15.6z"/>'#13 +
          #10#9'</g>'#13#10'</svg>'#13#10
      end
      item
        IconName = 'ViewAny'
        SVGText = 
      ...
      item
        IconName = 'WatchesWin'
        SVGText = 
          '<svg viewBox="0 0 32 32">'#13#10#9'<g transform="translate(-284.852 -81' +
          '3.673) translate(284.852 813.673)">'#13#10#9#9'<path id="Trazado_1777" d' +
          '="M28.6,3.4H3.4c-1.7,0-3.1,1.4-3.1,3.1v18.9c0,1.7,1.4,3.1,3.1,3.' +
          '1h25.2c1.7,0,3.1-1.4,3.1-3.1V6.6'#13#10#9#9#9'C31.7,4.9,30.3,3.4,28.6,3.4' +
          'z M28.6,25.4H3.4V6.6h25.2C28.6,6.6,28.6,25.4,28.6,25.4z"/>'#13#10#9'</g' +
          '>'#13#10#9'<path d="M26.6,15.4L26.6,15.4l-4.7-6.9l-1.5,1l2.6,3.9c-0.2,0' +
          '-0.4-0.1-0.6-0.1c-2,0-3.7,1.2-4.5,2.9c-0.6-0.4-1.3-0.6-2-0.6'#13#10#9#9 +
          's-1.4,0.2-2,0.6c-0.8-1.7-2.5-2.9-4.5-2.9c-0.2,0-0.3,0-0.5,0.1l2.' +
          '6-3.9l-1.5-1l-4.6,6.7c-0.7,0.9-1.1,2-1.1,3.1'#13#10#9#9'c0,2.8,2.3,5.1,5' +
          '.1,5.1s5.1-2.3,5.1-5.1c0-0.1,0-0.2,0-0.2c0.3-0.5,0.9-0.8,1.5-0.8' +
          's1.2,0.3,1.5,0.8c0,0.1,0,0.1,0,0.2'#13#10#9#9'c0,2.8,2.3,5.1,5.1,5.1s5.1' +
          '-2.3,5.1-5.1C27.6,17.4,27.2,16.4,26.6,15.4z M9.4,21.1c-1.4,0-2.6' +
          '-1.1-2.6-2.6s1.1-2.6,2.6-2.6'#13#10#9#9's2.6,1.1,2.6,2.6S10.8,21.1,9.4,2' +
          '1.1z M22.5,21.1c-1.4,0-2.6-1.1-2.6-2.6s1.1-2.6,2.6-2.6s2.6,1.1,2' +
          '.6,2.6S23.9,21.1,22.5,21.1z"/>'#13#10'</svg>'#13#10
      end
      item
        IconName = 'Web'
        SVGText = 
