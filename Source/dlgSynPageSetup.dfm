    ...
    SVGIconItems = <
      item
        ...
        SVGText = 
          ...
          'w.w3.org/2000/svg"><path d="m13.5 15.5h-3.5v-3h3.5a1.5 1.5 0 0 1' +
          ' 1.5 1.5 1.5 1.5 0 0 1 -1.5 1.5m-3.5-9h3a1.5 1.5 0 0 1 1.5 1.5 1' +
          '.5 1.5 0 0 1 -1.5 1.5h-3m5.6 1.29c.97-.68 1.65-1.79 1.65-2.79 0-' +
          '2.26-1.75-4-4-4h-6.25v14h7.04c2.1 0 3.71-1.7 3.71-3.79 0-1.52-.8' +
          '6-2.82-2.15-3.42z"/></svg>'
      end
      item
        IconName = 'PageSetup\Date'
        SVGText = 
          '<svg enable-background="new 0 0 32 32" viewBox="0 0 32 32" xmlns' +
          '="http://www.w3.org/2000/svg"><path d="m4.6 6.5h16.4v-4.1c0-1.1-' +
          '.9-2.1-2.1-2.1h-14.3c-.6 0-1.3.4-1.7 1-.1.2-.3.5-.3.7 0 .1-.1.3-' +
          '.1.5v18.8c0 1.1.9 2.1 2.1 2.1h4.2v-2.1h-4.2zm0-4.1h14.3v2.1h-14.' +
          '3z"/><path d="m27.4 8.8h-12.6c-.5-.7-1.3-1-2.2-1h-4.6v9.9h3v.8h-' +
          '5v2.3h5v8.9c0 1.1.9 2.1 2.1 2.1h14.3c1.1 0 2.1-.9 2.1-2.1v-18.9c' +
          '0-1.1-1-2-2.1-2zm-17.1.7h1.1s0 0-.1.1c-.2.2-.3.5-.3.7s-.1.3-.1.5' +
          'v.8.1h-.7v-2.2zm0 6.4v-2.1h.7v2.1zm17.1 13.7h-14.3v-8.9-2.3-.8-1' +
          '.8-.8h.8 1.8 3.3 8.4zm0-16.7h-8.4-4.2-1.7v-1.5-.6h.3.1 1.9 12z"/' +
          '><path d="m16.7 17.8h4.7l-.4.9-.6 1.4-1.6 3.2-1.2 2.7h2.5l3.7-8.' +
          '7v-1.2h-7.1z"/><path d="m14.4 26.7h11.7v2.3h-11.7z"/></svg>'
      end
      item
        IconName = 'PageSetup\Font'
        SVGText = 
          '<svg height="24" viewBox="0 0 24 24" width="24" xmlns="http://ww' +
          'w.w3.org/2000/svg"><path d="m17 8h3v12h1v1h-4v-1h1v-3h-4l-1.5 3h' +
          '1.5v1h-4v-1h1zm1 1-3.5 7h3.5zm-13-6h5c1.11 0 2 .89 2 2v11h-3v-5h' +
          '-3v5h-3v-11c0-1.11.89-2 2-2m1 2v4h3v-4z"/></svg>'
      end
      item
        IconName = 'PageSetup\Italic'
        SVGText = 
          '<svg height="24" viewBox="0 0 24 24" width="24" xmlns="http://ww' +
          'w.w3.org/2000/svg"><path d="m10 4v3h2.21l-3.42 8h-2.79v3h8v-3h-2' +
          '.21l3.42-8h2.79v-3z"/></svg>'
      end
      item
      ...
      item
        ...
        SVGText = 
          ...
          '3v24c0 1.7 1.3 3 3 3h18c1.7 0 3-1.3 3-3v-18zm6 27h-18v-24h10.5v7' +
          '.5h.5v1.4h-4v-4h-2v4h-4v2h4v4h-4v2h4v4h2v-4h4v4h2v-4h4v-2h-4v-4h' +
          '4v-2h-4v-1.4h5zm-7-13.1v4h-4v-4z"/></svg>'
      end
      item
        ...
        SVGText = 
          '<svg enable-background="new 0 0 32 32" viewBox="0 0 32 32" xmlns' +
          '="http://www.w3.org/2000/svg"><path d="m19 1h-12c-1.7 0-3 1.3-3 ' +
          '3v24c0 1.7 1.3 3 3 3h18c1.7 0 3-1.3 3-3v-18zm-12 27v-24h10.5v7.5' +
          'h7.5v16.5z"/><path d="m19.9 19.5v-4h-2v4h-4v2h4v4h2v-4h4v-2zm-2.' +
          '4-5.3v-2h-4v-4h-2v4h-4v2h4v4h2v-4z"/></svg>'
      end
      item
        IconName = 'PageSetup\Time'
        SVGText = 
          '<svg enable-background="new 0 0 32 32" viewBox="0 0 32 32" xmlns' +
          '="http://www.w3.org/2000/svg"><path d="m16 1c-8.3 0-15 6.8-15 15' +
          's6.8 15 15 15 15-6.8 15-15c0-8.4-6.8-15-15-15zm0 27c-6.6 0-12-5.' +
          '4-12-12s5.4-12 12-12 12 5.4 12 12-5.4 12-12 12zm.7-19.5h-2.3v9l7' +
          '.9 4.7 1.2-1.8-6.8-4z"/></svg>'
      end
      item
        IconName = 'PageSetup\Title'
        SVGText = 
          '<svg height="24" viewBox="0 0 24 24" width="24" xmlns="http://ww' +
          'w.w3.org/2000/svg"><path d="m5 4v3h5.5v12h3v-12h5.5v-3z"/></svg>'
      end
      item
        IconName = 'PageSetup\Underline'
        SVGText = 
          '<svg height="24" viewBox="0 0 24 24" width="24" xmlns="http://ww' +
          'w.w3.org/2000/svg"><path d="m5 21h14v-2h-14zm7-4a6 6 0 0 0 6-6v-' +
          '8h-2.5v8a3.5 3.5 0 0 1 -3.5 3.5 3.5 3.5 0 0 1 -3.5-3.5v-8h-2.5v8' +
          'a6 6 0 0 0 6 6z"/></svg>'
      end>
    Left = 430
    Top = 6
