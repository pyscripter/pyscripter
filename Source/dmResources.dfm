    ...
    SVGIconItems = <
      item
        ...
        SVGText = 
          ...
          '="0.5" fill="#E24444" cx="5.5" cy="7" r="4"/>'#13#10'</svg>'
      end
      item
    ...
    SVGIconItems = <
      ...
      item
        ...
        SVGText = 
          ...
          '7v29.7h-8.7v-3.2h4.4V4.4h-4.4V1.1z"/>'#13#10'</g>'#13#10'</svg>'
      end
      item
      ...
      item
        ...
        SVGText = 
          ...
          '.4l-6.4-6l3.5-2.8l6.2,5.9L24.5,23.4z"/>'#13#10#9'</g>'#13#10'</svg>'
      end
      item
        ...
        SVGText = 
          ...
          '1.9,6.1-5.7,7.1L20.6,28.8z"/>'#13#10'</g>'#13#10'</svg>'
      end
      item
        ...
        SVGText = 
          ...
          '8-0.8C24.3,29.7,24.7,29.3,25.2,29.3z"/>'#13#10'</g>'#13#10'</svg>'
      end
      item
    ...
    SVGIconItems = <
      ...
      item
        ...
        SVGText = 
          ...
          's5.4-12,12-12'#13#10#9#9's12,5.4,12,12S22.5,28.1,15.9,28.1z"/>'#13#10'</svg>'
      end
      item
      ...
      item
        ...
        SVGText = 
          ...
          '.3,3-3V10L19,1z M25,28H7V4h10.5v7.5H25V28z"/>'#13#10'</svg>'
      end
      item
      ...
      item
        ...
        SVGText = 
          ...
          ',16z M7,7h13.5v6H7V7z"/>'#13#10'</svg>'
      end>
    ApplyFixedColorToRootOnly = True
    Left = 24
    Top = 224
    ...
    SVGIconItems = <
      ...
      item
        ...
        SVGText = 
          ...
          '5 35.659188 25.659188 35 26.5 35 z"/>'#13#10'</svg>'
      end
      item
        IconName = 'Assistant'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          ...
          ',30.8 19,30.9 19,30.9 19,30.9 '#9'"/>'#13#10'</svg>'
      end
      item
        ...
        SVGText = 
          ...
          '2.7V5.2C31.3,3.7,30.1,2.5,28.6,2.5z"/>'#13#10'</svg>'
      end
      item
        IconName = 'Bug'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          ...
          '0.1-0.1-0.2-0.2-0.2H3.4z"/>'#13#10'</svg>'
      end
      item
        IconName = 'Cancel'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          ...
          ' 14.896484 z"/>'#13#10'</svg>'
      end
      item
        IconName = 'Chat\ChatNext'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          ...
          '12 3M18 14H20V17H23V19H20V22H18V19H15V17H18V14Z"/>'#13#10'</svg>'
      end
      item
        IconName = 'Chat\ChatPrev'
        SVGText = 
          '<svg viewBox="0 0 24 24">'#13#10'      <path d="M12,3C6.5,3 2,6.58 2,1' +
          '1C2.05,13.15 3.06,15.17 4.75,16.5C4.75,17.1 4.33,18.67 2,21C4.37' +
          ',20.89 6.64,20 8.47,18.5C9.61,18.83 10.81,19 12,19C17.5,19 22,15' +
      ...
      item
        ...
        SVGText = 
          ...
          '.6h12.3L16,21L9.8,30.6z"/>'#13#10'</svg>'
      end
      item
        IconName = 'Copy'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          ...
          #13#10#9#9'L31,4V2.5H26.5z"/>'#13#10'</svg>'
      end
      item
        IconName = 'Debug'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          ...
          '0-2,0.9-2,2s0.9,2,2,2H18.6L18.6,28.8z"/>'#13#10'</svg>'
      end
      item
        IconName = 'Dedent'
        SVGText = 
          ...
          '-4.2L0.7,16L6,21.3v-4.2h6.6V14.9z"/>'#13#10'</svg>'
      end
      item
        IconName = 'Delete'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          ...
          '4h-3.4'#13#10#9#9'l5.3,5.3l5.3-5.3H18L17.9,13.3L17.9,13.3z"/>'#13#10'</svg>'
      end
      item
        IconName = 'Edit'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          ...
          'H336a24,24,0,0,0,0,48H464A24,24,0,0,0,488,464Z"/>'#13#10'</svg>'
      end
      item
        IconName = 'Editor'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          ...
          '12.9 M9.7,14.4h12.5l-6.3-9.8L9.7,14.4z"/>'#13#10'</svg>'
      end
      item
      ...
      item
        ...
        SVGText = 
          ...
          '.8z M279.6,345.2v-23.4h9.9v7.3h7.1v16.1H279.6z"/>'#13#10'</g>'#13#10'</svg>'
      end
      item
        IconName = 'FileOpen'
        SVGText = 
          ...
          ',1.5,1.7,3.3,2.1,5.6H-92.4z"/>'#13#10#9'</g>'#13#10'</svg>'
      end
      item
      ...
      item
        ...
        SVGText = 
          ...
          ',469.1 170.3,468.5 172,466.8 172.7,466 "/>'#13#10#9'</g>'#13#10'</svg>'
      end
      item
      ...
      item
        ...
        SVGText = 
          ...
          '4.1h8.5v3.3h-8.5V24.1z"/>'#13#10'</svg>'
      end
      item
        IconName = 'Font'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          ...
          '3c0-3.4,4.6-3.8,4.6-7.6C22.1,9.6,19.3,6.9,16,6.9z"/>'#13#10'</svg>'
      end
      item
        IconName = 'Highlight'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          ...
          '6v4.2l5.3-5.3l-5.3-5.3V15H0.7V17.2z"/>'#13#10'</svg>'
      end
      item
        IconName = 'Info'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          ...
          '7.6h22.6v-3.2H8.7V17.6z"/>'#13#10'</svg>'
      end
      item
        IconName = 'Link'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          ...
          '.4,1.6,1C-87.5,249.7-87.5,250.4-88,250.9z"/>'#13#10'</g>'#13#10'</svg>'
      end
      item
        IconName = 'PageSetup'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          ...
          'v4.3h14.6v-4.3h2.9V354.8z"/>'#13#10'</g>'#13#10'</svg>'
      end
      item
        IconName = 'Pause'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          ...
          '5,3.2,25,2.5S24.2,1,23.5,1'#13#10#9#9'L23.5,1z"/>'#13#10'</svg>'
      end
      item
        IconName = 'Plus'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          ...
          ' 21.8,21.5 21.8,16.9 23.7,16.9 23.7,21.5 '#9'"/>'#13#10'</svg>'
      end
      item
      ...
      item
        ...
        SVGText = 
          ...
          '1,30.7,24.7,27.9,27.5z"/>'#13#10'</svg>'
      end
      item
      ...
      item
        ...
        SVGText = 
          ...
          '.9,18.2 25.2,19.5 25.2,19.5 26.6,20.8 29.8,24 '#9#9'"/>'#13#10'</svg>'
      end
      item
        IconName = 'PyDoc'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          ...
          #9#9'c0-1.7,1.4-3,3-3s3,1.3,3,3S17.6,19,15.9,19z"/>'#13#10'</svg>'
      end
      item
        IconName = 'PySetupAdd'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          ...
          '3.3-7.3,7.3-7.3s7.3,3.3,7.3,7.3S26.7,29.9,22.8,29.9z"/>'#13#10'</svg>'
      end
      item
        IconName = 'Python'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          ...
          'L25.5,1C25,0.5,24.3,0.2,23.6,0.2L23.6,0.2z"/>'#13#10'</svg>'
      end
      item
        IconName = 'Redo'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          ...
          '3L589.3,381.6z"/>'#13#10'</g>'#13#10'</svg>'
      end
      item
        IconName = 'Search'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          ...
          '2.1,4.8,4.8S15.1,21.2,12.4,21.2z"/>'#13#10'</svg>'
      end
      item
        IconName = 'Setup'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          ...
          'h18.2V23.9z M25.2,15.1H6.9'#13#10#9'V9.3h18.2V15.1z"/>'#13#10'</svg>'
      end
      item
      ...
      item
        ...
        SVGText = 
          ...
          '520.6" cy="74.4" r="3.7"/>'#13#10'</g>'#13#10'</svg>'
      end
      item
        IconName = 'Stop'
        SVGText = 
          ...
          '1,16l5.4-5.4L21.4,8.5z'#13#10#9#9'"/>'#13#10'</svg>'
      end
      item
        IconName = 'Styles'
        SVGText = 
          ...
          ' y="10.2" width="4.3" height="4.4"/>'#13#10'</svg>'
      end
      item
        IconName = 'TabClose'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          ...
          '2,16.6 15.6,14.3 13.4,12.2 7.4,18.1 8.1,18.7 '#9'"/>'#13#10'</svg>'
      end
      item
        IconName = 'Tabs'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          ...
          'M7.2,26.5h3.8V5.5H7.2V26.5z"/>'#13#10'</svg>'
      end
      item
        ...
        SVGText = 
          ...
          'l6.1,3.9L14,19.9V12.2 M11.7,8v16.1L24.4,16L11.7,8z"/>'#13#10'</svg>'
      end
      item
        IconName = 'Title'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          ...
          ' x="15.6" y="15.5" width="2.6" height="2.6"/>'#13#10'</svg>'
      end
      item
      ...
      item
        ...
        SVGText = 
          ...
          ',2.3,16.2,7.4C-66.6,251.3-71.1,244-81.4,242.6z"/>'#13#10'</g>'#13#10'</svg>'
      end
      item
      ...
      item
        ...
        SVGText = 
          ...
          'v-4'#13#10#9#9'h3.4L16,12L10.7,17.3z"/>'#13#10'</svg>'
      end
      item
      ...
      item
        ...
        SVGText = 
          ...
          ' width="8.6" height="2.8"/>'#13#10'</svg>'
      end
      item
        IconName = 'ViewStart'
        SVGText = 
          ...
          '" width="8.7" height="2.9"/>'#13#10'</svg>'
      end
      item
        IconName = 'Watch'
        SVGText = 
      ...
      item
        ...
        SVGText = 
          ...
          '3h1.5v-3h3v-1.5h-3V8.8z"/>'#13#10'</svg>'
      end
      item
        IconName = 'ZoomOut'
        SVGText = 
      ...
      item
        IconName = 'LLMProviders\DeepSeek'
        SVGText = 
  ...
  object icEditorMarks: TSVGIconImageCollection
    SVGIconItems = <
      ...
      item
        IconName = 'BugFix'
        SVGText = 
          '<svg viewBox="0 0 22 28">'#13#10'  <title>bug-check</title>'#13#10'  <path t' +
          'ransform="translate(-3, 0) scale(1.2)"'#13#10'    d="M19 7H16.19C15.74' +
          ' 6.2 15.12 5.5 14.37 5L16 3.41L14.59 2L12.42 4.17C11.96 4.06 11.' +
          '5 4 11 4S10.05 4.06 9.59 4.17L7.41 2L6 3.41L7.62 5C6.87 5.5 6.26' +
          ' 6.21 5.81 7H3V9H5.09C5.03 9.33 5 9.66 5 10V11H3V13H5V14C5 14.34' +
          ' 5.03 14.67 5.09 15H3V17H5.81C7.26 19.5 10.28 20.61 13 19.65V19C' +
          '13 16.46 14.61 14.2 17 13.35V13H19V11H17V10C17 9.66 16.97 9.33 1' +
          '6.91 9H19V7M13 15H9V13H13V15M13 11H9V9H13V11" />'#13#10'  <path fill="' +
          'crimson" transform="translate(-5, -1) scale(1.2)"'#13#10'    d="M17.75' +
          ' 22.16L15 19.16L16.16 18L17.75 19.59L21.34 16L22.5 17.41L17.75 2' +
          '2.16Z" />'#13#10'</svg>'
      end
      item
        IconName = 'QuickFix'
        SVGText = 
          '<svg viewBox="0 0 22 28">'#13#10'  <path fill="gold"'#13#10'    d="M7.5,5.6L' +
          '5,7L6.4,4.5L5,2L7.5,3.4L10,2L8.6,4.5L10,7L7.5,5.6M19.5,15.4L22,1' +
          '4L20.6,16.5L22,19L19.5,17.6L17,19L18.4,16.5L17,14L19.5,15.4M22,2' +
          'L20.6,4.5L22,7L19.5,5.6L17,7L18.4,4.5L17,2L19.5,3.4L22,2" />'#13#10'  ' +
          ' <path transform="translate(-3,4) rotate(-8)"'#13#10'      d="M13.34,1' +
          '2.78L15.78,10.34L13.66,8.22L11.22,10.66L13.34,12.78M14.37,7.29L1' +
          '6.71,9.63C17.1,10 17.1,10.65 16.71,11.04L5.04,22.71C4.65,23.1 4,' +
          '23.1 3.63,22.71L1.29,20.37C0.9,20 0.9,19.35 1.29,18.96L12.96,7.2' +
          '9C13.35,6.9 14,6.9 14.37,7.29Z" />'#13#10'  </svg>'
        ApplyFixedColorToRootOnly = True
      end
      item
        IconName = 'Wrench'
        SVGText = 
          '<svg  viewBox="0 0 22 28">'#13#10'  <path fill="crimson" transform=" s' +
          'cale(1.2, 1) translate(10, -4) rotate(45)"'#13#10'    d="M22.7,19L13.6' +
          ',9.9C14.5,7.6 14,4.9 12.1,3C10.1,1 7.1,0.6 4.7,1.7L9,6L6,9L1.6,4' +
          '.7C0.4,7.1 0.9,10.1 2.9,12.1C4.8,14 7.5,14.5 9.8,13.6L18.9,22.7C' +
          '19.3,23.1 19.9,23.1 20.3,22.7L22.6,20.4C23.1,20 23.1,19.3 22.7,1' +
          '9Z" />'#13#10'</svg>'
      end>
    ApplyFixedColorToRootOnly = True
