...
type
  ...
  public
    ...
    function SyntaxCheck(const FileId: string; out ErrorPos: TEditorPos; Quiet:
...
function TPyInternalInterpreter.SyntaxCheck(const FileId: string; out ErrorPos:
    TEditorPos; Quiet: Boolean = False): Boolean;
var
  Py: IPyEngineAndGIL;
  FName: string;
  Source: AnsiString;
