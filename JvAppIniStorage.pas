...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvAppIniStorage.pas 13145 2011-11-02 21:15:19Z ahuser $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jcl.svn.sourceforge.net/svnroot/jvcl/trunk/jvcl/run/JvAppIniStorage.pas $';
    Revision: '$Revision: 13145 $';
    Date: '$Date: 2011-11-02 23:15:19 +0200 (Τετ, 02 Νοε 2011) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
