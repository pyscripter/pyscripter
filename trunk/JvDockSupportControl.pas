...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvDockSupportControl.pas 10836 2006-07-23 17:46:20Z jfudickar $
...
{$ENDIF DELPHI6_UP}
  ...
  protected
{$IFDEF DELPHI6_UP}
    AlphaBlendedForm : TJvAlphaBlendedForm;
{$ENDIF DELPHI6_UP}
...
begin
  ...
  FCtrlDown := False;
{$IFDEF DELPHI6_UP}
  AlphaBlendedForm := TJvAlphaBlendedForm.CreateNew(nil);
  with AlphaBlendedForm do begin
    Visible := False;
    Color := clHighlight;
    AlphaBlend := True;
    AlphaBlendValue := 140;
