object CommandsDataModule: TCommandsDataModule
  ...
  object Images: TTBImageList
    ...
    Top = 188
    Bitmap = {
      494C010183008600040010001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
      ...
      803FFFF793EE0000C07FFFFFFFFF0000C001FFFFFFFFFFE7C00180808000FFE3
    ...
    MultipleStrings = <
      item
        ...
        Strings.Strings = (
          ...
          '        try:'
          '            return self.ImmDict(self._getmembers(x))'
          '        except:'
          '            return self.ImmDict({})'
          ''
